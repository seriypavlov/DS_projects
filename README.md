...
#### Результат: Для данной задачи было несколько моделей. Лучшая в плане качества предсказания, скорости предсказания, времи обучения оказалась - LGBMRegressor. Т.к. лучше всего справляется с поставленной задачей.
